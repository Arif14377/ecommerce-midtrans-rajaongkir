  ...
  return (
    <Routes>
      ...
      <Route path="/admin">
        ...
        {/* ============ ROUTE USERS ============ */}
        <Route path="users">
          {/* Route Index - permission users-index */}
          <Route
            index
            element={<ProtectedRoute component={UsersIndex} requiredPermission="users-index" />}
          />

          {/* Route Create - permission users-create */}
          <Route
            path="create"
            element={<ProtectedRoute component={UserCreate} requiredPermission="users-create" />}
          />

          {/* Route Edit - permission users-edit */}
          <Route
            path="edit/:id"
      ...
      <Route path="/dashboard">
        ...
        <Route path="orders/:id" element={<ProtectedRoute component={WebOrderDetail} requiredRole="user" />} />
      </Route>
    </Routes>
  );
}
