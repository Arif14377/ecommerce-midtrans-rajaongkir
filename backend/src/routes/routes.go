...
import (
	"github.com/arif14377/ecommerce-midtrans-rajaongkir/src/controllers"
	adminController "github.com/arif14377/ecommerce-midtrans-rajaongkir/src/controllers/admin"
	publicController "github.com/arif14377/ecommerce-midtrans-rajaongkir/src/controllers/public"
	"github.com/arif14377/ecommerce-midtrans-rajaongkir/src/middlewares"
	ws "github.com/arif14377/ecommerce-midtrans-rajaongkir/src/websocket"
...
func SetupRouter() *gin.Engine {
	...
	userProtected.Use(middlewares.AuthMiddleware())
	{
		...
		userProtected.PUT("/carts/:id", publicController.UpdateCart)
